...
local MapPoints = {
    ...
    { 1, "Moonwhisper Coast",   0.22,  0.74,  "TransportRoutes",           "boat",      LZ["Moonhoof Village"],                                                 { AtlasCFM.Server.TURTLE } }, -- Boat to Moonhoof Village (1.18.1)
    { 1, "Azshara",             0.69,  0.39,  "TransportRoutes",           "boat",      LZ["Shadowprey Village"],                                               { AtlasCFM.Server.TURTLE } }, -- Boat to Shadowprey Village (1.18.1)

...
-- Marker Data
-- Format: { continent, EN zone name, x, y, key, type, info }
...
local MapPoints = {
    ...
    { 1, "Durotar",             0.51,  0.115, "TransportRoutes",           "zepp",      LMD["Grom'Gol"],                                                        { AtlasCFM.Server.TURTLE1, AtlasCFM.Server.CLASSIC } }, -- Zeppelins to Grom'Gol
    { 1, "Durotar",             0.51,  0.115, "TransportRoutes",           "zepp",      LMD["Kargath"],                                                         { AtlasCFM.Server.VANILLA_PLUS } }, -- Zeppelins to Kargath
    { 1, "Durotar",             0.41,  0.195, "TransportRoutes",           "zepp",      LZ["Thunder Bluff"],                                                    { AtlasCFM.Server.TURTLE1 } }, -- Zeppelins to TB
    { 1, "Durotar",             0.41,  0.165, "TransportRoutes",           "zepp",      LMD["Kargath"],                                                         { AtlasCFM.Server.TURTLE1 } }, -- Zeppelins to Kargath
    { 1, "Thunder Bluff",       0.165, 0.230, "TransportRoutes",           "zepp",      LZ["Orgrimmar"],                                                        { AtlasCFM.Server.TURTLE1 } }, -- Zeppelin to Orgrimmar
    { 1, "Durotar",             0.598, 0.236, "TransportRoutes",           "boat",      LMD["Revantusk Village"],                                               { AtlasCFM.Server.TURTLE1 } }, -- Boat to Revantusk Village
    { 1, "The Barrens",         0.636, 0.389, "TransportRoutes",           "boat",      LZ["Booty Bay"] .. ", " .. LZ["Tanaris"],                               { AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Booty Bay, Tanaris
    { 1, "The Barrens",         0.636, 0.389, "TransportRoutes",           "boat",      LZ["Booty Bay"],                                                        { AtlasCFM.Server.TURTLE1, AtlasCFM.Server.CLASSIC } }, -- Boat to Booty Bay
    { 1, "Darkshore",           0.324, 0.44,  "TransportRoutes",           "boat",      LF["Stormwind"],                                                        { AtlasCFM.Server.TURTLE1 } }, -- Boat to Stormwind
    { 1, "Darkshore",           0.324, 0.44,  "TransportRoutes",           "boat",      LF["Menethil Harbor"],                                                  { AtlasCFM.Server.CLASSIC, AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Menethil
    { 1, "Darkshore",           0.304, 0.41,  "TransportRoutes",           "boat",      LMD["Alah'Thalas"],                                                     { AtlasCFM.Server.TURTLE1 } }, -- Boat to Alah'Thalas (1.17.2)
    ...
    { 1, "Thousand Needles",    0.435, 0.409, "TransportRoutes",           "zepp",      LMD["Grom'Gol"],                                                        { AtlasCFM.Server.VANILLA_PLUS } }, -- Zepplin to Grom'Gol
    { 1, "Desolace",            0.22,  0.74,  "TransportRoutes",           "boat",      LZ["Moonhoof Village"],                                                 { AtlasCFM.Server.TURTLE } }, -- Boat to Moonhoof Village (1.18.1)
    { 1, "Moonwhisper Coast",   0.69,  0.39,  "TransportRoutes",           "boat",      LZ["Shadowprey Village"],                                               { AtlasCFM.Server.TURTLE } }, -- Boat to Shadowprey Village (1.18.1)
    { 1, "Feralas",             0.31,  0.40,  "TransportRoutes",           "boat",      LZ["Auberdine"],                                                        { AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Auberdine
    { 1, "Darkshore",           0.31,  0.41,  "TransportRoutes",           "boat",      LZ["Feralas"],                                                          { AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Feralas
    { 1, "Tanaris",             0.68,  0.23,  "TransportRoutes",           "boat",      LZ["Ratchet"] .. ", " .. LZ["Booty Bay"],                               { AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Ratchet, Booty Bay
    ...
    { 2, "Stormwind City",      0.694, 0.294, "TransportRoutes",           "tram",      LZ["Ironforge"],                                                        { AtlasCFM.Server.TURTLE1 } }, -- Tram to Ironforge (Turtle)
    { 2, "Stormwind City",      0.61,  0.12,  "TransportRoutes",           "tram",      LZ["Ironforge"],                                                        { AtlasCFM.Server.CLASSIC, AtlasCFM.Server.VANILLA_PLUS } }, -- Tram to Ironforge                                                          -- Tram to Ironforge
    { 2, "Ironforge",           0.762, 0.511, "TransportRoutes",           "tram",      LZ["Stormwind"] },                                                            -- Tram to Stormwind
    { 2, "The Hinterlands",     0.812, 0.794, "TransportRoutes",           "boat",      LMD["Sparkwater Port"],                                                 { AtlasCFM.Server.TURTLE1 } }, -- Boat to Sparkwater Port
    { 2, "Wetlands",            0.068, 0.613, "TransportRoutes",           "boat",      LZ["Theramore Isle"] },                                                       -- Boat to Theramore Isle
    { 2, "Wetlands",            0.057, 0.570, "TransportRoutes",           "boat",      LZ["Auberdine"],                                                        { AtlasCFM.Server.CLASSIC, AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Auberdine
    { 2, "Stormwind City",      0.218, 0.563, "TransportRoutes",           "boat",      LZ["Auberdine"],                                                        { AtlasCFM.Server.TURTLE1 } }, -- Boat to Auberdine
    { 2, "Stormwind City",      0.22,  0.413, "TransportRoutes",           "boat",      LZ["Balor"],                                                            { AtlasCFM.Server.TURTLE } }, -- Fly to Balor
    { 2, "Stranglethorn Vale",  0.257, 0.73,  "TransportRoutes",           "boat",      LZ["Ratchet"],                                                          { AtlasCFM.Server.TURTLE1, AtlasCFM.Server.CLASSIC } }, -- Boat to Ratchet
    { 2, "Stranglethorn Vale",  0.257, 0.73,  "TransportRoutes",           "boat",      LZ["Tanaris"] .. ", " .. LZ["Ratchet"],                                 { AtlasCFM.Server.VANILLA_PLUS } }, -- Boat to Tanaris, Ratchet
    ...
    { 2, "Stranglethorn Vale",  0.31,  0.29,  "TransportRoutes",           "zepp",      LZ["Orgrimmar"],                                                        { AtlasCFM.Server.TURTLE1, AtlasCFM.Server.CLASSIC } }, -- Zeppelins to Orgrimmar
    { 2, "Stranglethorn Vale",  0.31,  0.29,  "TransportRoutes",           "zepp",      LZ["Thousand Needles"],                                                 { AtlasCFM.Server.VANILLA_PLUS } }, -- Zeppelins to Thousand Needles
    { 2, "Badlands",            0.050, 0.470, "TransportRoutes",           "zepp",      LZ["Orgrimmar"],                                                        { AtlasCFM.Server.TURTLE1, AtlasCFM.Server.VANILLA_PLUS } }, -- Zeppelin to Orgrimmar
    { 2, "Alah'Thalas",         0.531, 0.047, "TransportRoutes",           "boat",      LZ["Auberdine"],                                                        { AtlasCFM.Server.TURTLE1 } }, -- Boat to Auberdine (1.17.2)
    -- PVP Entrances

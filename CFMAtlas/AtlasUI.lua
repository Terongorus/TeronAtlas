...
do
    ...
    topTexture:SetTexture(AtlasCFM.PATH .. "Images\\AtlasCFMFrame-Top")
    ...
    leftTexture:SetTexture(AtlasCFM.PATH .. "Images\\AtlasCFMFrame-Left")
    ...
    bottomTexture:SetTexture(AtlasCFM.PATH .. "Images\\AtlasCFMFrame-Bottom")
    ...
    bottom2Texture:SetTexture(AtlasCFM.PATH .. "Images\\AtlasCFMFrame-Bottom2")
    ...
    rightTexture:SetTexture(AtlasCFM.PATH .. "Images\\AtlasCFMFrame-Right")
